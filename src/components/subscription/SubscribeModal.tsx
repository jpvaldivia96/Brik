...
const plans = [
    {
        ...
        features: ['Dashboard en vivo', 'Registro de entrada/salida', 'Reportes básicos'],
    ...
    },
    {
        ...
        name: 'Pro',
        price: '$70',
        limit: '2000 registros/mes',
        popular: true,
        features: ['Todo de Free', 'Alertas personalizadas', 'Reportes avanzados', 'Control de fiscalización', 'Soporte prioritario'],
    ...
    },
    {
        ...
        price: 'Custom',
        limit: 'Ilimitado',
        features: ['Todo de Pro', 'API de integración', 'Multi-obra', 'Configuración dedicada', 'SLA garantizado'],
