...
import { Settings, FileText, History, LayoutDashboard, X, Users, ClipboardCheck, Bell, Upload, Building2, CreditCard, Shield } from 'lucide-react';
...
const adminOptions = [
  ...
  { id: 'trust-db', icon: Shield, label: 'Red de Seguridad', description: 'Alertas entre obras', supervisorOnly: true },
