      ...
      <div className="fixed bottom-0 left-0 right-0 backdrop-blur-xl bg-slate-900/80 border-t border-white/10 z-50 pb-safe">
        <div className="flex items-center justify-center gap-2 px-3 py-3">
          ...
          <button
            ...
            className={cn(
              "flex flex-col items-center justify-center gap-0.5 px-2 py-2 rounded-xl transition-all duration-300",
              activeAction === 'worker'
          ...
          <div className="flex flex-col items-center">
            <button
              ...
              className="flex items-center gap-2 px-8 py-2 rounded-xl transition-all duration-300 bg-gradient-to-r from-emerald-500 via-teal-500 to-purple-600 text-white shadow-lg shadow-emerald-500/40 hover:shadow-xl hover:shadow-emerald-500/60 hover:scale-105 active:scale-95"
            >
            ...
            <button
              ...
              className="text-[10px] text-white/50 hover:text-emerald-400 mt-1.5 transition-colors underline underline-offset-2"
            >
              manual
            </button>
          </div>
          ...
          <div className="flex flex-col items-center">
            <button
              ...
              className="flex items-center gap-2 px-8 py-2 rounded-xl transition-all duration-300 bg-gradient-to-r from-red-500 via-orange-500 to-purple-600 text-white shadow-lg shadow-red-500/40 hover:shadow-xl hover:shadow-red-500/60 hover:scale-105 active:scale-95"
            >
            ...
            <button
              ...
              className="text-[10px] text-white/50 hover:text-red-400 mt-1.5 transition-colors underline underline-offset-2"
            >
              manual
            </button>
          </div>
