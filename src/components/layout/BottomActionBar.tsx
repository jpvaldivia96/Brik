      ...
      <div className="fixed bottom-0 left-0 right-0 backdrop-blur-xl bg-slate-900/80 border-t border-white/10 z-50 pb-safe">
        <div className="flex items-center justify-center gap-2 sm:gap-3 px-3 sm:px-4 py-3 sm:py-4">
          ...
          <button
            ...
            className={cn(
              "flex flex-col items-center justify-center gap-0.5 px-2.5 py-2.5 sm:px-3 sm:py-3 rounded-xl transition-all duration-300",
              activeAction === 'worker'
          ...
          >
            ...
            <span className="text-[9px] sm:text-[10px] font-medium">Trabajador</span>
          </button>
          ...
          <div className="flex flex-col items-center">
            <button
              ...
              className="flex items-center gap-2 sm:gap-2.5 px-6 sm:px-10 py-2.5 sm:py-3 rounded-xl transition-all duration-300 bg-gradient-to-r from-emerald-500 via-teal-500 to-purple-600 text-white shadow-lg shadow-emerald-500/40 hover:shadow-xl hover:shadow-emerald-500/60 hover:scale-105 active:scale-95"
            >
              <LogIn className="w-5 h-5 sm:w-6 sm:h-6" />
              <span className="text-sm sm:text-base font-semibold">Entrada</span>
            </button>
            <button
              onClick={() => handleManualOpen('entry')}
              className="text-[10px] sm:text-[11px] text-white/50 hover:text-emerald-400 mt-1.5 sm:mt-2 transition-colors underline underline-offset-2"
            >
              manual
            </button>
          </div>
          ...
          <div className="flex flex-col items-center">
            <button
              ...
              className="flex items-center gap-2 sm:gap-2.5 px-6 sm:px-10 py-2.5 sm:py-3 rounded-xl transition-all duration-300 bg-gradient-to-r from-red-500 via-orange-500 to-purple-600 text-white shadow-lg shadow-red-500/40 hover:shadow-xl hover:shadow-red-500/60 hover:scale-105 active:scale-95"
            >
              <LogOut className="w-5 h-5 sm:w-6 sm:h-6" />
              <span className="text-sm sm:text-base font-semibold">Salida</span>
            </button>
            <button
              onClick={() => handleManualOpen('exit')}
              className="text-[10px] sm:text-[11px] text-white/50 hover:text-red-400 mt-1.5 sm:mt-2 transition-colors underline underline-offset-2"
            >
              manual
            </button>
          </div>
          ...
          >
            ...
            <span className="text-[9px] sm:text-[10px] font-medium">Visitante</span>
          </button>
          ...
          >
            ...
            <span className="text-[9px] sm:text-[10px] font-medium">Favoritos</span>
          </button>
        </div>
      </div>
